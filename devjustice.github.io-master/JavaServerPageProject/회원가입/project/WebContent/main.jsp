...
<head>
<meta charset="UTF-8">
	<title>정의인 사이트에 오신것을 환영합니다</title>
...
<body>
<form class="signUp" id="signupForm" action="loginCheck.jsp" method="post">
   <h1 class="signUpTitle">정의인 사이트에 오신것을 환영합니다</h1> 
  <input type="text" class="signUpInput" placeholder="Type your username" autofocus required name="id">
   <input type="password" class="signUpInput" placeholder="Choose a password" required name="password">
